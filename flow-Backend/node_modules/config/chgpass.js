...
if (npass.match(/([a-z].*[A-Z])|([A-Z].*[a-z])/) &&
npass.length > 4 && npass.match(/[0-9]/) && npass.match(/.[!,@,#,$,%,^,&,*,?,_,~]/)) {
...
//send random string to User's email address to reset password (nodemailer SMTP)
var temp =rand(24, 24);
...
var mailOptions = {
     from: "Robert  <Robert@flow.com>",
     to: email,
     subject: "Password Reset ",
     text: "Hello "+email+". \n Here is your reset code for your Password: "+temp+". \n Cheers, \n flow team",
